...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'invitechat',
          path: '/invitechat',
          builder: (context, params) => InvitechatWidget(),
        ),
        FFRoute(
          name: 'ChatPage',
          path: '/chatPage',
        ...
        FFRoute(
          ...
          path: '/followpage',
          asyncParams: {
            'followers': getDocList(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => FollowpageWidget(
            following: params.getParam<DocumentReference>(
                'following', ParamType.DocumentReference, true, ['users']),
            followers: params.getParam<UsersRecord>(
                'followers', ParamType.Document, true),
          ),
        ),
        FFRoute(
          name: 'browseprofile',
          path: '/browseprofile',
          asyncParams: {
            'userreference': getDoc(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => BrowseprofileWidget(
            userreference: params.getParam('userreference', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'allusers',
        ...
        FFRoute(
          ...
          builder: (context, params) => EditPostWidget(
            editPost: params.getParam(
                'editPost', ParamType.DocumentReference, false, ['userPosts']),
          ),
        ),
        FFRoute(
          name: 'initialsetting',
          path: '/initialsetting',
          builder: (context, params) => InitialsettingWidget(),
        )
