...
import '/components/notnull/notnull_widget.dart';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Autocomplete<String>(
                                    initialValue: TextEditingValue(
                                        text: editProfileUsersRecord.sex),
                                    optionsBuilder: (textEditingValue) {
                                      if (textEditingValue.text == '') {
                                        return const Iterable<String>.empty();
                                      }
                                      return ['男'].where((option) {
                                        final lowercaseOption =
                                            option.toLowerCase();
                                        return lowercaseOption.contains(
                                            textEditingValue.text
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController3 ??=
                                        TextEditingController(
                                      text:
                                          editProfileUsersRecord.age.toString(),
                                    ),
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController4 ??=
                                        TextEditingController(
                                      text: editProfileUsersRecord.cigarQuantity
                                          .toString(),
                                    ),
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController5 ??=
                                        TextEditingController(
                                      text: editProfileUsersRecord.cigarPrice
                                          .toString(),
                                    ),
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 15.0, 0.0, 40.0),
                                ...
                                if (_model.textController5.text != null &&
                                  ...
                                  if (!(_model.uploadedFileUrl != null &&
                                    ...
                                    await currentUserReference!
                                      ...
                                      age: int.tryParse(
                                          _model.textController3.text),
                                      sex: _model.textController2.text,
                                      cigarQuantity: int.tryParse(
                                          _model.textController4.text),
                                      cigarPrice: int.tryParse(
                                          _model.textController5.text),
                                    ));
                                    context.safePop();
                                    return;
